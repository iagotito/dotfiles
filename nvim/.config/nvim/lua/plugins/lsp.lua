-- took lots of nvim >0.11 lsp configs from:
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Diagnostics
        map('<space>e', vim.diagnostic.open_float, 'Open [E]rror Float')
        map('[d', vim.diagnostic.goto_prev, 'Previous [D]iagnostic')
        map(']d', vim.diagnostic.goto_next, 'Next [D]iagnostic')
        map('<space>q', vim.diagnostic.setloclist, 'Set [Q]uickfix List')
